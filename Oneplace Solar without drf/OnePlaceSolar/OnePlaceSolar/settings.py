"""
Django settings for OnePlaceSolar project.
...
SECRET_KEY = 'django-insecure-b@gfu0%o)w8*xl9dh(jz=03j1!gn!(muj02t7$385m=_#&px98'
...
WSGI_APPLICATION = 'OnePlaceSolar.wsgi.application'
...
AUTH_USER_MODEL = 'ClientDashboard.ClientUsers'
